                ...
                <div className='h-[65vh] m-auto full flex gap-10 relative rounded-md mt-3'>
                    {stream && (
                        <video
                            ...
                            ref={myVideo}
                            autoPlay
                            className={`w-[40%] border-[5px]  h-[20vh] lg:w-[90%] absolute top-0 left-0 z-10 object-cover ${callAccept ? 'lg:w-[25vw] lg:h-[40%] z-[999]' : 'w-full h-full  object-cover rounded-md '}`}                        ></video>   
                    )}
                    {callAccept && (
                        <video
                            playsInline
